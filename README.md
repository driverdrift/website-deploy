...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/botshell/website-deploy/main/install.sh) y
```
Or run the code below to install manually.
```bash
bash <(wget -qO- https://raw.githubusercontent.com/botshell/website-deploy/main/install.sh)
```
